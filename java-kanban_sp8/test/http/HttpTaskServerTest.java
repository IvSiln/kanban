...
public class HttpTaskServerTest {private static KVServer kvServer;
    private static HttpTaskServer taskServer;
    private static Gson gson = new GsonBuilder().registerTypeAdapter(LocalDateTime.class, new LocalDateTimeTypeAdapter()).create();
    ...
    void shouldGetTasks() {
        HttpClient client = HttpClient.newHttpClient();
        URI url = URI.create(TASK_BASE_URL);
        Task task = new Task("name", "detail", Status.NEW, LocalDateTime.now(), Duration.between(LocalTime.MIN, LocalTime.of(0, 35, 0)));
    ...
    void shouldGetEpics() {
        ...
        Epic epic = new Epic("name1", "detail1", Status.NEW);
        ...
        try {
            ...
            if (postResponse.statusCode() == 201) {
                ...
                Subtask subtask = new Subtask("description1", "name1", Status.NEW, epic.getId()
                        , LocalDateTime.now(),Duration.between(LocalTime.MIN, LocalTime.of(0, 5, 0)));
                url = URI.create(SUBTASK_BASE_URL);
    ...
    void shouldGetTaskById() {
        HttpClient client = HttpClient.newHttpClient();
        URI url = URI.create(TASK_BASE_URL);
        Task task = new Task("description1", "name1", Status.NEW, LocalDateTime.now(), Duration.between(LocalTime.MIN, LocalTime.of(0, 5, 0)));
    ...
    void shouldGetSubtaskById() {
        ...
        try {
            ...
            if (postResponse.statusCode() == 201) {
                ...
                epic.setId(epicId);
                Subtask subtask = new Subtask("description1", "name1", Status.NEW, epic.getId()
                        , LocalDateTime.now(),Duration.between(LocalTime.MIN, LocalTime.of(0, 45, 0)));
                url = URI.create(SUBTASK_BASE_URL);
    ...
    void shouldUpdateTask() {
        HttpClient client = HttpClient.newHttpClient();
        URI url = URI.create(TASK_BASE_URL);
        Task task = new Task("description1", "name1", Status.NEW, LocalDateTime.now(), Duration.between(LocalTime.MIN, LocalTime.of(0, 50, 0)));
    ...
    void shouldUpdateSubtask() {
        ...
        try {
            ...
            if (postResponse.statusCode() == 201) {
                ...
                epic.setId(epicId);
                Subtask subtask = new Subtask("description1", "name1", Status.NEW, epic.getId()
                        , LocalDateTime.now(),Duration.between(LocalTime.MIN, LocalTime.of(0, 32, 0)));
                url = URI.create(SUBTASK_BASE_URL);
    ...
    void shouldDeleteTasks() {
        HttpClient client = HttpClient.newHttpClient();
        URI url = URI.create(TASK_BASE_URL);
        Task task = new Task("description1", "name1", Status.NEW, LocalDateTime.now(), Duration.between(LocalTime.MIN, LocalTime.of(0, 20, 0)));
    ...
    void shouldDeleteSubtasks() {
        ...
        try {
            ...
            if (postResponse.statusCode() == 201) {
                ...
                epic.setId(epicId);
                Subtask subtask = new Subtask("description1", "name1", Status.NEW, epic.getId()
                        , LocalDateTime.now(),Duration.between(LocalTime.MIN, LocalTime.of(0, 10, 0)));
                url = URI.create(SUBTASK_BASE_URL);
    ...
    void shouldDeleteTaskById() {
        HttpClient client = HttpClient.newHttpClient();
        URI url = URI.create(TASK_BASE_URL);
        Task task = new Task("name", "detail", Status.NEW, LocalDateTime.now(), Duration.between(LocalTime.MIN, LocalTime.of(0, 60, 0)));
    ...
    void shouldDeleteSubtaskById() {
        ...
        try {
            ...
            if (postResponse.statusCode() == 201) {
                Subtask subtask = new Subtask("description1", "name1", Status.NEW, epic.getId()
                        , LocalDateTime.now(), Duration.between(LocalTime.MIN, LocalTime.of(0, 25, 00)));
                url = URI.create(SUBTASK_BASE_URL);
